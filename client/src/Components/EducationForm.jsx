        ...
        <div className='space-y-6'>
            <div>
                ...
                text-gray-900'>Education</h3>
                        <p className='text-sm text-gray-500'>Add Your job education details</p>
                    </div>
            ...
            {data.length === 0 ? (
                <div className='text-center py-8 text-gray-500'>
                    ...
                    <p>No work eduaction added yet.</p>
                ...
                <div className='space-y-4'>
                  ...
                  transition-colors'>
                            ...
                            <input value={education.gpa || ""} onChange={(e) => updateEducation(index, "gpa", e.target.value)} type='text' className='px-3 py-2 text-sm '
